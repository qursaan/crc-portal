...
#available_nodes: list of strings, ex. ['node1w', 'node2w', ...]
#topology_mmaping: boolean (True/False)

#Return a list of used nodes, ex. ['node1w', 'node2w', ...], the list will be empty if the experiment is invalid or cannot be run
...
def run_node_emulation(xml_file_path, task_id):
	...
	call(["/root/generate_run_scripts", "{0}".format(xml_file_path), "{0}".format(xml_file_path)])
